...
int _g_m3axpi_::sUserWidth = 1280;
int _g_m3axpi_::sUserHeight = 720;
// int _g_m3axpi_::sUserWidth = 1920;
// int _g_m3axpi_::sUserHeight = 1080;
...
PYBIND11_MODULE(m3axpidataset, m) {
    ...
    m.def("camera", &g_m3axpi_camera, py::arg("CameraWidth") = 1280, py::arg("CameraHeight") = 720, py::arg("SysCase") = 0, py::arg("HdrMode") = 1, py::arg("FrameRate") = 30);
    // m.def("camera", &g_m3axpi_camera, py::arg("CameraWidth") = 1920, py::arg("CameraHeight") = 1080, py::arg("SysCase") = 0, py::arg("HdrMode") = 1, py::arg("FrameRate") = 30);
